...
Custom greenwood configurations can be added to a `greenwood.config.js` file in your workspace directory. For example, you may want to change the `src` folder to something else such as `www`. By default, you can use a relative path. You can also use an absolute path.
