...
Now, you can author [SSR pages](/docs/server-rendering/) using Lit templates and components using Greenwood's [`getBody` API](https://www.greenwoodjs.dev/docs/server-rendering/#usage).  The below is an example of generating a template of LitElement based `<app-card>` web components.
...
> _See the [isolation configuration](https://www.greenwoodjs.dev/docs/configuration/#isolation) docs for more information._
