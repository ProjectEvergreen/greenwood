 ...
 * a link of blog posts derivered from a pages/blog directory.  Also uses LitElement.
 *
 * User Result
...
describe('Build Greenwood With: ', function() {
  const LABEL = 'ChildrenQuery from GraphQL';
  ...
  describe(LABEL, function() {
    ...
    describe('Home (Page Template) <posts-list> w/ ChildrenQuery', function() {
      ...
      it('should have a expected ChildrenQuery output in the <body> tag for posts list', function() {
